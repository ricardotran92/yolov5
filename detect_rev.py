...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            cv2.putText(im0, total_vehicle_count, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0), 2)
            ...
            cv2.putText(im0, total_wrong_vehicle_count, (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0), 2)
            # new4: close
